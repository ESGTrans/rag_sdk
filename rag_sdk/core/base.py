...
class RAGCore:
    ...
    def __init__(
        self, llm_model: str = "gpt-3.5-turbo", 
        embedding_model: str = "shibing624/text2vec-base-chinese", 
        vector_database_uri: str = None, collection_list: list = []
    ):
    ...
    def show_available_collections(self):
        assert self.vector_database_uri is not None, "vector_database_uri is not provided!"
        pass
    ...
    def chat(
        ...
        response = self.request_sender.send_streaming_request(
            "POST", uri, data=data
        )
        return response
